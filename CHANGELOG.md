...
## [0.2.0](https://github.com/skharchikov/polymarket-bot/releases/tag/v0.2.0) - 2026-03-08

### Fixed

- add workflow_dispatch to release-plz, clean stale branches
- include all commits in release-plz changelog

### Other

- bump version to 0.2.0 for Bayesian update release
- Replace probability averaging with Bayesian likelihood ratio updating
- Deploy only on release tag, not every push to main
- Add Polymarket links to signal Telegram messages
- release v0.1.0
